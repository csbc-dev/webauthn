...
export class WebAuthnCore extends EventTarget {
  ...
  private _setStatus(status: WebAuthnStatus): void {
    ...
    this._status = status;
    this._target.dispatchEvent(new CustomEvent("passkey-auth:status-changed", {
  ...
  private _setCredentialId(id: string): void {
    ...
    this._target.dispatchEvent(new CustomEvent("passkey-auth:credential-id-changed", {
  ...
  private _setUser(user: WebAuthnUser | null): void {
    ...
    this._user = user;
    this._target.dispatchEvent(new CustomEvent("passkey-auth:user-changed", {
