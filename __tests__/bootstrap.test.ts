...
describe("bootstrap + registration", () => {
  ...
  it("setConfig updates the live config read by callers", () => {
    ...
    // class is already bound to "passkey-auth" from an earlier test, so
